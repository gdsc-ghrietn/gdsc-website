...
const TeamMemberCard: React.FC<TeamMemberProps> = ({ image_url, fullName, position, github, linkedin }) => {
  return (
    <div className="w-25  h-2/5 bg-white flex flex-col  items-center rounded-sm  shadow-[4px__3px_0px] shadow-red-600 m-6">
      ...
      <div className="flex flex-col items-center h-[60%] w-full justify-center">
        <h2 className="text-2xl font-game1 w-full flex justify-center word-wrap text-black">{fullName}</h2>
        <h2 className="text-lg font-game1 w-[80%] flex justify-center word-wrap text-gray-500">{position}</h2>

...
const About = () => {
    return (
        <div className="relative w-full min-h-screen md:h-screen flex flex-col justify-evenly uppercase ">
            <div className="z-10 text-xl lg:text-2xl font-normal text-white font-game2 flex items-center justify-center">
                About Us
            </div>
            <div className="z-10 flex flex-col lg:max-w-[75%] xl:max-w-[61%] px-7 md:px-10 lg:pl-20 space-y-6">
